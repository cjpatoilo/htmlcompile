...
[Open an Issue](https://github.com/cjpatoilo/htmlcompile/issues/new) to report any problems or improvements. When necessary, use some online service to show the problem. Be sure to include some description to explain the problem.
